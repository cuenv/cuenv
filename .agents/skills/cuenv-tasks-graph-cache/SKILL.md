...
- Non-hermetic tasks default to the directory containing the `env.cue` file that defines the task; use task `dir` only for an explicit CUE-module-root-relative override.
