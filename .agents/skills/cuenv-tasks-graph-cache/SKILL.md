...
- CLI task-event rendering and spinner integration live in `crates/events/src/renderers/cli/task.rs`; non-task renderer categories stay in the CLI renderer root.
