...
- Entries are salted with `cuenv_cas::ACTION_SEMANTICS_VERSION`, not the cuenv release version. Bump it only when execution semantics change; a release must not invalidate the cache.
