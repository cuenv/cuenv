...
- `crates/core/src/tasks`, including `crates/core/src/tasks/graph/resolver.rs` for task path resolution, and `crates/cuenv/src/commands/task` when behavior matters.
