...
- Container runtime support is schema-only until the matrix says otherwise. RFC-0007 will compile `#ContainerRuntime` to Dagger as image-only sugar; that does not change today's status.
