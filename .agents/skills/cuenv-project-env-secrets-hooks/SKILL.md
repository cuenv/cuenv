...
- `crates/1password/src/secrets/core.rs` owns the WASM SDK host functions. Keep memory offsets checked against the `i64` host ABI boundary and Unix-time conversion saturating rather than cast-suppressed.
