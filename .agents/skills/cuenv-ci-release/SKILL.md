...
- `crates/core/src/contributors.rs` for task contributor activation/injection, and `crates/core/src/contributors/workspace.rs` for built-in package-manager workspace contributors.
