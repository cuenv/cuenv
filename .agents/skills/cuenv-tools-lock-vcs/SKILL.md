...
- `crates/tools/runtime/src/activation.rs` for activation schema/mutation rules and `crates/tools/runtime/src/activation/path_index.rs` for lockfile provider path discovery.
