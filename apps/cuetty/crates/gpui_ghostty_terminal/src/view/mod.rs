...
use gpui::{
    App, Bounds, ClipboardItem, Context, Element, ElementId, ElementInputHandler, FocusHandle,
    GlobalElementId, IntoElement, KeyBinding, KeyDownEvent, LayoutId, MouseButton, MouseDownEvent,
    MouseMoveEvent, MouseUpEvent, PaintQuad, Pixels, Render, ScrollDelta, ScrollWheelEvent,
    SharedString, Style, TextRun, UnderlineStyle, Window, actions, div, fill, hsla, point,
...
fn row_index_for_local_position(
    rows: usize,
    cell_height: f32,
    position: gpui::Point<gpui::Pixels>,
) -> usize {
...
mod tests {
    ...
    use super::{
        ...
        url_at_byte_index, url_at_column_in_line, window_position_to_local,
    };
