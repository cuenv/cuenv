			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Generate EditorConfig', slug: 'how-to/editorconfig' },
						{ label: 'Typed environments', slug: 'how-to/typed-environments' },
						{ label: 'Secrets', slug: 'how-to/secrets' },
						{ label: 'Build container images', slug: 'how-to/container-images' },
						{ label: 'Nix', slug: 'how-to/nix' },
						{ label: 'Lockfiles', slug: 'how-to/lockfiles' },
						{ label: 'Manage releases', slug: 'how-to/releases' },
						{ label: 'Tools', slug: 'how-to/tools' },
						{ label: 'Choosing a runtime', slug: 'how-to/runtimes' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'cuenv-codegen', slug: 'explanation/cuenv-codegen' },
						{ label: 'cuenv-formatters', slug: 'explanation/cuenv-formatters' },
