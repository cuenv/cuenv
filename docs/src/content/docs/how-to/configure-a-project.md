...
Manager, and `schema.#ExecSecret` for custom command-backed providers. GCP and
Vault schema types exist, but their default runtime resolvers are not registered yet.
