...
- Tasks: groups, sequences, params, output refs, caching, `timeout`, `retry`, `continueOnError`, and group `maxConcurrency` are real; filesystem hermeticity still needs explicit limitation notes.
