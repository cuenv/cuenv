...
- Feature specifications remain underspecified, especially while files such as [crates/cuenv/tests/bdd/features/env.feature](crates/cuenv/tests/bdd/features/env.feature:1) are empty.
...
5. **Testing and Validation**
   - Add scenarios to [crates/cuenv/tests/bdd/features/env.feature](crates/cuenv/tests/bdd/features/env.feature:1) covering exports and secret filtering.
...
- Populate [crates/cuenv/tests/bdd/features/env.feature](crates/cuenv/tests/bdd/features/env.feature:1) with scenarios referencing this contract.
...
| ------------------------------------------------------------ | --------------------------------------- | ------------------------------------------------------------------- |
| [crates/cuenv/tests/bdd/features/env.feature](crates/cuenv/tests/bdd/features/env.feature:1)       | Pending scenarios for print/export/exec | Will validate filtering and shell exports.                          |
| [crates/cuenv/tests/bdd/features/hooks.feature](crates/cuenv/tests/bdd/features/hooks.feature:104) | Environment persistence scenario        | Depends on the export contract defined here.                        |
| [crates/cuenv/tests/bdd/features/task.feature](crates/cuenv/tests/bdd/features/task.feature:1)     | Pending                                 | Task execution may reference environment behaviour for subcommands. |
