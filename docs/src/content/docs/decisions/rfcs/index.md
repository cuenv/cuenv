...
This section enumerates open design proposals targeted for stabilization or adoption.

## Active RFCs

- [RFC-0001: CLI Command Surface and Subcommand Hierarchy](/decisions/rfcs/rfc-0001-cli-command-surface/)
