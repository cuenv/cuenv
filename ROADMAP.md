...
_Goal: Make Cuenv the best local development tool, replacing `just` and `direnv`._
...
2.  **Secret Provider Plugins**
    ...
    - **Tasks:**
      ...
      - Ensure secrets are _only_ in memory during process execution and never leaked to disk/logs.
...
_Goal: Enable "Bazel-lite" reliability for builds and tests._
...
_Goal: Support monorepos and team collaboration._
