...
mod tests {
    ...
    fn test_sync_codeowners_empty() {
        ...
        let output = sync_codeowners(Path::new("."), &rules, false, false);
        assert!(output.is_empty());
    }

    #[test]
    fn test_sync_codeowners_with_rules() {
        let mut rules = HashMap::new();
        rules.insert(
            "*.rs".to_string(),
            cuenv_core::owners::OwnerRule {
        ...
        let output = sync_codeowners(Path::new("."), &rules, false, false);
        assert!(output.contains("1 ownership rules"));
    }
